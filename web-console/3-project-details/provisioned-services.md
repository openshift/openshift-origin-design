...
![template](img/provisioned_services_collapsed.png)
...
![template](img/provisioned_services_use_cases.png)
  ...
  - The View Console link should open in a new browser window/tab.

![template](img/pending.png)
...
### Secondary Masthead
![template](img/expanded_state_1.png)
  - In the expanded view there may be up to three sections: Configuration details, Provisioned Resources and Bindings.
  - The Configuration Details section shows details for the service instance. Binding configurations are shown on the Provisioned Service details page.
  - Provisioned Resources are any resources that the service has created in the project namespace.
...
#### Implementation Details
  ...
  - The Configuration and Provisioned Resources sections are not displayed if there are no data to show.

![template](img/expanded_state_2.png)
  ...
  - The Create binding action is not available until the service has been provisioned successfully and is available.
