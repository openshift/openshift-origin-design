...
### Browse Catalog
- Selecting `Browse Catalog` from the dropdown or clicking the link to view more search results will navigate the user to the [Catalog](http://openshift.github.io/openshift-origin-design/web-console/projject-details/in-project-catalog) inside that project.
